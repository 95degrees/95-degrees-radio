package me.voidinvoid.discordmusic.audio.twitch;
...
import static me.voidinvoid.discordmusic.audio.twitch.TwitchKrakenStreamAudioSourceManager.createGetRequest;
...
public class TwitchStreamSegmentUrlProvider extends M3uStreamSegmentUrlProvider {
    ...
    private JsonBrowser loadAccessToken(HttpInterface httpInterface) throws IOException {
        HttpUriRequest request = TwitchKrakenStreamAudioSourceManager.createGetRequest("https://api.twitch.tv/api/channels/" + channelName +

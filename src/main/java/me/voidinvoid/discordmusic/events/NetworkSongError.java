...
public enum NetworkSongError {
    ...
    QUEUE_LIMIT_REACHED("Song could not be queued because you already have at least " + RadioConfig.config.orchestration.userQueueLimit + " suggested songs in the queue"),
